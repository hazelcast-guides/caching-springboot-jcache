= Caching in Spring Boot with Hazelcast and JCache
...
:description: This tutorial will get you started with Hazelcast as a JCache provider for your Spring Boot application.
...
[source,java]
----
include::ROOT:example$src/main/java/com/hazelcast/springboot/caching/BookController.java[tag=BookController]
----

.BookService.java
[source,java]
----
include::ROOT:example$src/main/java/com/hazelcast/springboot/caching/BookService.java[tag=BookService]
----
...
[source,xml]
----
include::ROOT:example$pom.xml[tag=hazelcast,indent=0]
----
...
[source,yaml]
----
include::ROOT:example$src/main/resources/hazelcast.yaml[]
----
...
[source,properties]
----
include::ROOT:example$src/main/resources/application.properties[]
----
...
[source,properties]
----
include::ROOT:example$src/main/resources/application-embedded.properties[]
----
